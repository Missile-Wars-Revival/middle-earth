...
declare const MissileTheNuke: Missileitem;
declare const MissileZippy: Missileitem;
...
export { Msg, WebSocketMessage, GeoLocation, Player, LocationUpdate, Missile, Landmine, Loot, GameItem, Missileitem, MissileAmplifier, MissileBallista, MissileClusterBomb, MissileTheNuke, MissileZippy, PlayerMissileHit, PlayerLandmineHit, PlayerLootHit, PlayerMissileMiss, PlayerLandmineMiss, FetchMissiles, MissileGroup, MissileType, Missile1, Missile2, Missile3, LandmineType, Landmine1, Landmine2, Landmine3, zip, zip_single, unzip, classify };
