...
declare class Missile extends Msg {
    ...
    constructor(type: string, status: string, destination: GeoLocation, currentLocation: GeoLocation, missileId: number, radius: number, damage: number, sentbyusername: string, timesent: string, etatimetoimpact: string);
...
declare class Landmine extends Msg {
    ...
    constructor(id: number, type: string, location: GeoLocation, placedby: string, placedtime: string, etaexpiretime: string);
